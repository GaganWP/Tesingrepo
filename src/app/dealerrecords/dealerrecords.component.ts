...
@Component({
  selector: 'app-dealerrecords',
  templateUrl: './dealerrecords.component.html',
  styleUrls: ['./dealerrecords.component.css']
})
export class DealerrecordsComponent implements OnInit {
