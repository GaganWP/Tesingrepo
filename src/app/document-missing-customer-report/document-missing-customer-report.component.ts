...
@Component({
  selector: 'app-document-missing-customer-report',
  templateUrl: './document-missing-customer-report.component.html',
  styleUrls: ['./document-missing-customer-report.component.css']
})
export class DocumentMissingCustomerReportComponent implements OnInit {
...
console.log(this.utype)
	...
	public getRecords(dateStr: string) {
	  ...
	  public exportTableToExcel(): void {
		...
		const filename = 'document-missing-applications.xls';
