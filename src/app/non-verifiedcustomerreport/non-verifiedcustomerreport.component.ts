...
@Component({
  selector: 'app-non-verifiedcustomerreport',
  templateUrl: './non-verifiedcustomerreport.component.html',
  styleUrls: ['./non-verifiedcustomerreport.component.css']
})
export class NonVerifiedcustomerreportComponent implements OnInit {
...
console.log(this.utype)
	...
	public getRecords(dateStr: string) {
	  ...
	  public exportTableToExcel(): void {
		...
		const filename = 'non-verified-applications.xls';
