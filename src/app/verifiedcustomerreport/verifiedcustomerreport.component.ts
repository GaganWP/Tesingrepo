...
@Component({
  selector: 'app-verifiedcustomerreport',
  templateUrl: './verifiedcustomerreport.component.html',
  styleUrls: ['./verifiedcustomerreport.component.css']
})
export class VerifiedcustomerreportComponent implements OnInit {
...
console.log(this.utype)
	...
	public getRecords(dateStr: string) {
	  ...
	  public exportTableToExcel(): void {
		...
		const filename = 'verified-applications.xls';
