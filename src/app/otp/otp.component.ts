...
console.log(this.utype)
	...
	public getRecords(dateStr: string) {
		...
		console.log(this.dateStr);
		 ...
		 this.http.get('https://ekyc.chili.mu:9443/api/todayActiveOtp')
		 .subscribe(response => {
			...
			this.isLoading = false;
			this.errorMsg = 'Data not found for this MSISDN ';
		});
    ...
    public generateOtp(msisdn){
      var url = 'https://ekyc.chili.mu:9443/otp/sendOtpAgent/'+msisdn+'/en'
