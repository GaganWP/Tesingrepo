...
@Component({
  selector: 'app-tourist-report',
  templateUrl: './tourist-report.component.html',
  styleUrls: ['./tourist-report.component.css']
})
export class TouristReportComponent implements OnInit {
...
console.log(this.utype)
	...
	public getRecords(dateStr: string) {
	  ...
	  public exportTableToExcel(): void {
		...
		const filename = 'tourist-applications.xls';
